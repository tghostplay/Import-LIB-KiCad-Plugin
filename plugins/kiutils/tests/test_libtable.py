...
class Tests_LibTable(unittest.TestCase):
    ...
    def test_addLibraryObjectToLibTable(self):
        ...
        self.testData.pathToTestFile = path.join(
            LIBTABLE_BASE, "test_addLibraryObjectToLibTable"
        )
        libtable = LibTable(type="fp_lib_table")
        libtable.libs.append(
            Library(
                name="object1",
                type="KiCad",
    ...
    def test_addEmptyLibraryObjectToLibTable(self):
        ...
        self.testData.pathToTestFile = path.join(
            LIBTABLE_BASE, "test_addEmptyLibraryObjectToLibTable"
        )
        libtable = LibTable(type="fp_lib_table")
    ...
    def test_createNewLibTable(self):
        ...
        self.testData.pathToTestFile = path.join(
            LIBTABLE_BASE, "test_createNewLibTable"
        )
