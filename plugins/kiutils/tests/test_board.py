...
class Tests_Board(unittest.TestCase):
    ...
    def test_boardStackup32LayerDielectricsVias(self):
        ...
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "test_boardStackup32LayerDielectricsVias"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_boardWithAllPrimitives(self):
        ...
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "test_boardWithAllPrimitives"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_allFpManufacturingAttributes(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "test_allFpManufacturingAttributes"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        ...
        # parsed footprint
        attr = Attributes(
            boardOnly=False, excludeFromBom=False, excludeFromPosFiles=False, type=None
        )
        self.assertEqual(
            attr,
            board.footprints[11].attributes,
    ...
    def test_footprintPadNewLines(self):
        ...
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "test_renameFootprintIdToken"
        )
        board = Board().from_file(self.testData.pathToTestFile)
    ...
    def test_zoneOnOuterLayersOnly(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "test_zoneOnOuterLayersOnly"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_zoneOnAllLayersWildcard(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "test_zoneOnAllLayersWildcard"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
...
class Tests_Board_Since_V7(unittest.TestCase):
    ...
    def test_textBoxAllVariants(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "since_v7", "test_textBoxAllVariants"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_imageWithLayerToken(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "since_v7", "test_imageWithLayerToken"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_pcbPlotParams(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "since_v7", "test_pcbPlotParams"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_textsWithRenderCaches(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "since_v7", "test_textsWithRenderCaches"
        )
        board = Board().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(board, self.testData))
    ...
    def test_testKnockout(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            BOARD_BASE, "since_v7", "test_textKnockout"
        )
