...
class Tests_Footprint_Legacy(unittest.TestCase):
    ...
    def test_moduleNameOnlyNumbers(self):
        ...
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "legacy", "test_moduleNameOnlyNumbers"
        )
...
class Tests_Footprint(unittest.TestCase):
    ...
    def test_allFootprintItems(self):
        ...
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_allFootprintItems"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_footprintPadNewLines(self):
        ...
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_footprintPadNewLines"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_footprintEmptyAttributes(self):
        ...
        """
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_footprintEmptyAttributes"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_createNewFootprintTypeSMD(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_createNewFootprintTypeSMD"
        )

        # Create footprint with correct type
        footprint = Footprint().create_new(
            type="smd", library_id="empty-footprint-smd", value="empty-footprint-smd"
        )
    ...
    def test_createNewFootprintTypeTHT(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_createNewFootprintTypeTHT"
        )
    ...
    def test_createNewFootprintTypeOther(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_createNewFootprintTypeOther"
        )
    ...
    def test_3dModelHideProperty(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "test_3dModelHideProperty"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
...
class Tests_Footprint_Since_V7(unittest.TestCase):
    ...
    def test_textBoxAllVariants(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_textBoxAllVariants"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_imageWithLayerToken(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_imageWithLayerToken"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_textsWithRenderCaches(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_textsWithRenderCaches"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_exemptFromCourtyardToken(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_exemptFromCourtyardToken"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_3dModelOpacityToken(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_3dModelOpacityToken"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_privateLayersToken(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_privateLayersToken"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_netTiePadGroups(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_netTiePadGroups"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
    ...
    def test_testKnockout(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(
            FOOTPRINT_BASE, "since_v7", "test_textKnockout"
        )
        footprint = Footprint().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(footprint, self.testData))
